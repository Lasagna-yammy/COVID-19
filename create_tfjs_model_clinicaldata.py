# -*- coding: utf-8 -*-
"""
Created on Mon Jan 15 21:17:24 2024
...
# Read the CSV file
coviddata =pd.read_csv('4deep_clinical.csv', encoding="utf-8").to_numpy()
...
tfjs.converters.save_keras_model(model, "./tfjs_model_clinicaldata")
