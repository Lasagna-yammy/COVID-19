# -*- coding: utf-8 -*-
"""
Created on Mon Jan 15 21:23:45 2024
...
# Read the CSV file
coviddata =pd.read_csv('4deep_clinicalblood.csv', encoding="utf-8").to_numpy()
...
print("training data:",len(covid_train))

# Set the ExplanatoryVariables
print("columns:", len(covid_all[1]))
...
print(covid_ytrain.shape)

# Use 1/5 as verification data
covid_test = covid5
print("test data:",len(covid_test))
...
# # Convert h5 file to js file
import tensorflowjs as tfjs
tfjs.converters.save_keras_model(model, "./tfjs_model_clinicalblooddata")
